...
@section('content')
    ...
    <div class="d-flex my-4">
        <h2 class="text-primary me-auto"><span class="material-symbols-rounded">people</span>
            {{ trans('messages.subscribers') }}</h2>
        <div class="text-end">
    ...
    <div class="listing-form subscribers-list" data-url="{{ action('SubscriberController@listing', $list->uid) }}"
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a data-control="add-tag" href="#" class="dropdown-item"
                                        ...
                                        {{ trans('messages.subscriber.add_tag') }}
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item assign-values-button"
                                        href="{{ action('SubscriberController@assignValues', $list->uid) }}">
                                        <span class="material-symbols-rounded">control_point_duplicate</span>
                                        {{ trans('messages.subscriber.assign_values') }}
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" link-method="POST"
                                        link-confirm="{{ trans('messages.subscribe_subscribers_confirm') }}"
                                ...
                                <li>
                                    <a class="dropdown-item list-action-single" link-method="POST"
                                        ...
                                        href="{{ action('SubscriberController@resendConfirmationEmail', $list->uid) }}">
                                        <span class="material-symbols-rounded">mark_email_read</span>
                                ...
                                <li>
                                    <a href="{{ action('SubscriberController@bulkDelete', $list->uid) }}"
                                        ...
                                        <span class="material-symbols-rounded">delete_outline</span>
                                        {{ trans('messages.subscriber.bulk_delete') }}
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <ul class="dropdown-menu list-columns-checkbox dropdown-menu-end"
                                    ...
                                    <li>
                                        <a href="javascript:;" class="dropdown-item">
                                            <label class="d-flex align-items-center">
                                                <input {{ $field->required || $key <= 3 ? "checked='checked'" : '' }}
                                                    type="checkbox" id="{{ $field->tag }}" name="columns[]"
                                                    value="{{ $field->uid }}" class="styled">
                            ...
                            <li>
                                <a class="dropdown-item checkbox">
                                    <label class="d-flex align-items-center">
                                        <input checked="checked" type="checkbox" id="created_at" name="columns[]"
                                            value="created_at" class="styled">
                            ...
                            <li>
                                <a class="dropdown-item checkbox">
                                    <label class="d-flex align-items-center">
                                        <input checked="checked" type="checkbox" id="updated_at" name="columns[]"
                                            value="updated_at" class="styled">
