...
<div class="condition-line" rel="{{ $index }}">
    <div class="row list-segment-container">
        ...
        <div class="col-md-4 list_select_box" target-box="segments-select-box"
        ...
        <div class="col-md-5 segments-select-box multiple">
            @if (
                $lists_segment_group['list'] &&
                    collect($lists_segment_group['list']->readCache('SegmentSelectOptions', []))->count())
                @include('helpers.form_control', [
