...
@section('content')
    <form id="classic-builder-form" action="{{ action('CampaignController@builderClassic', $campaign->uid) }}"
        ...
        <form>
            ...
            <script>
                var urlFill = new UrlAutoFill([{
                        ...
                        text: '{{ trans('messages.editor.unsubscribe_text') }}'
                    },
                    {
                        value: '{UPDATE_PROFILE_URL}',
                        text: '{{ trans('messages.editor.update_profile_text') }}'
                    },
                    {
                        value: '{WEB_VIEW_URL}',
                        text: '{{ trans('messages.editor.click_view_web_version') }}'
                    }
                ]);
                            ...
                            $.ajax({
                                ...
                                statusCode: {
                                    ...
                                    400: function(res) {
                                        ...
                                        // notify
                                        parent.notify('error', '{{ trans('messages.notify.error') }}',
                                            res.responseText);
                                    }
                                },
                            ...
                            editor.ui.registry.addMenuButton('acelletags', {
                                ...
                                fetch: function(callback) {
                                    ...
                                    items.push({
                                        ...
                                        onAction: function(_) {
                                            editor.insertContent(
                                                '<a href="{UNSUBSCRIBE_URL}">{{ trans('messages.editor.unsubscribe_text') }}</a>'
                                                );
                                        }
                                    });
                                    ...
                                    items.push({
                                        ...
                                        onAction: function(_) {
                                            editor.insertContent(
                                                '<a href="{WEB_VIEW_URL}">{{ trans('messages.editor.click_view_web_version') }}</a>'
                                                );
                                        }
                                    });
