    ...
    <div class="page-title">
        <ul class="breadcrumb breadcrumb-caret position-right">
            ...
            <li class="breadcrumb-item"><a
                    href="{{ action('CampaignController@index') }}">{{ trans('messages.campaigns') }}</a></li>
        </ul>
        <h1>
...
@section('content')
    <form action="{{ action('CampaignController@recipients', $campaign->uid) }}" method="POST"
        class="form-validate-jqueryz recipients-form">
        {{ csrf_field() }}
                ...
                <div style="display: flex; flex-direction: row; align-items: center;">
                    ...
                    <div style="padding-right: 40px;">
                        ...
                        <p style="padding-bottom:5px">
                            {{ trans('messages.cronjob.warning.description', [
        ...
        <div class="addable-multiple-form">
            ...
            <br />
            <a sample-url="{{ action('CampaignController@listSegmentForm', $campaign->uid) }}" href="#add_condition"
                class="btn btn-secondary add-form">
        ...
        <div class="text-end">
            <button class="btn btn-secondary">{{ trans('messages.save_and_next') }} <span
